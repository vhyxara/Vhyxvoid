...
const CustomOptionMenu = props => {
  // Props
  const { icon, iconClassName, options, leftAlignMenu, iconButtonProps, DialogComponent } = props
  ...
  const handleOptionClick = option => {
    if (option.dialog) {
      setShowComponent(option.dialog) // Set the dialog component to show
    }
